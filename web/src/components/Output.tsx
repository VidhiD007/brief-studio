...
export function Output({ wizard }: { wizard: Wizard }) {
  ...
  return (
    <div className="output-page" style={{ display: "flex", flexDirection: "column", background: "#1e1e24", fontFamily: "var(--font-sans)" }}>
      <div className="no-print output-header" style={{ height: 56, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 28px", borderBottom: "1px solid #2a2a32", flexShrink: 0 }}>
        ...
        <div className="output-header-title" style={{ fontSize: 16, fontWeight: 600, color: "#f0ece4" }}>Design Strategy Document</div>
        <div className="output-header-actions" style={{ display: "flex", gap: 10 }}>
